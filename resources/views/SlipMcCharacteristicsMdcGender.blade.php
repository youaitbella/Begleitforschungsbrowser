...
@section('titel')
    C-2-1-1: Vollstationäre Fälle in belegärztl. Versorgung, nach MDC und Geschlecht, G-DRG-Version {{$year}}, Datenjahr {{$year}}
@endsection
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <table id="tabelle_1_sum" class="table table-bordered table-striped">
                        <thead>
                        <tr>
                            <th class="text-right">Fälle</th>
                            <th class="text-right">Fälle W.</th>
                            <th class="text-right">Fälle M.</th>
                            <th class="text-right">Fälle U..</th>
                            <th class="text-right">Ant. W.</th>
                            <th class="text-right">Ant. M.</th>
                            <th class="text-right">Ant. U.</th>
                        </tr>
                        </thead>
                        <tbody>
